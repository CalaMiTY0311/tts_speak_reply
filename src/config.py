...
cnhubert_path = "GPT_SoVITS_tools/GPT_SoVITS/pretrained_models/chinese-hubert-base"
bert_path = "GPT_SoVITS_tools/GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large"
